...
document.querySelector('.roll').addEventListener('click', function () {
	if (gameStart) {
		...
		if (player === 1) {
			...
			document.querySelector('#player' + player + '-total-score').textContent = plater1TotalScore;
			...
			document.querySelector('#player' + player + '-total-score').textContent = plater2TotalScore;
			document.querySelector('.panel-' + player).classList.remove('active');
			player = 1;
			document.querySelector('.panel-' + player).classList.add('active');
		}
